...
class CustomImageDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            exit()
        label = int(self.img_labels.iloc[idx,1]) # sting이면 안됨.
        if self.transform:
            image = self.tranform(image) # totensor처럼
...
epochs = 10 # 학습을 10회 한다.
lr = 0.01
momentum = 0.5 # 조금만 더 해보고 떨어지면 계속 학습해봐. optimizer의 인자임.
no_cuda = True
seed = 1
log_interval = 200
